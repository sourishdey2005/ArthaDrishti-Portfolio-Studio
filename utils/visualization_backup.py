...
class Visualizer:
    ...
    def plot_aroon_indicator(self, ohlc_df, ticker, period=25):
        ...
        fig.add_trace(go.Scatter(x=ohlc_df.index, y=aroon_oscillator, mode='lines', name='Oscillator', line=dict(color='#8b5cf6', width=1.5), fill='tozeroy', fillcolor='rgba(139, 92, 246, 0.2)'))
        fig.add_hline(y=0, line_dash='dot', line_color='#64748b')
